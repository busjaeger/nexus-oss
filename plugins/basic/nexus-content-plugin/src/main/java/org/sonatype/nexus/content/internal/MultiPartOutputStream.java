 ...
 *
 * Modified from Jetty: precede every encapsulation boundary with CRLF
 * (to be consistent with spec and apache httpd)
 * 
*/
class MultiPartOutputStream extends FilterOutputStream
{
    ...
    public void close()
         throws IOException
    {
        out.write(__CRLF); // modified: removed 'inPart' check
